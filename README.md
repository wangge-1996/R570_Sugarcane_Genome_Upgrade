...
Code for the paper: Upgraded genome with ultra-long Nanopore reads facilitates resistance-gene discovery in sugarcane. This pipeline enables gap filling and head-tail extension of genomes.
## Installation
### Getting started
```bash
